(function () {
  ...
  window.CanvasSlideshow = function (options) {
    ...
    this.initPixi = function () {
      ...
      document.getElementById('canvas_sec').appendChild(renderer.view);
    ...
    for (var i = 0; i < nav.length; i++) {
      ...
      navItem.onclick = function (event) {
        ...
        if (this.getAttribute('data-nav') === '1') {
          that.moveSlider(0);
          
        }
        else if (this.getAttribute('data-nav') === '2') {
          that.moveSlider(1);
          
        }
        else if (this.getAttribute('data-nav') === '3') {
          that.moveSlider(2);
          
        }
        else if (this.getAttribute('data-nav') === '4') {
          that.moveSlider(3);
